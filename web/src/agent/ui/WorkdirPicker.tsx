...
import { WorkdirBrowser } from "../../components/cc/WorkdirBrowser";
...
export function WorkdirPicker({
  ...
  const [siblings, setSiblings] = useState<readonly AgentDirectoryEntry[]>([]);
  const [browseChildren, setBrowseChildren] = useState<readonly AgentDirectoryEntry[]>([]);
