...
export function AgentStatisticsPreview() {
  return (
    <main className="agent-statistics-preview">
      <div className="agent-statistics-preview__frame">
        <header className="agent-statistics-preview__header">
          <div>
            <span>本机观察</span>
            <h1>统计</h1>
          </div>
          <div className="agent-statistics-preview__sample">脱敏样例</div>
        </header>
        <nav className="agent-statistics-preview__tabs" aria-label="统计视图">
        ...
        <div className="agent-statistics-preview__content">
