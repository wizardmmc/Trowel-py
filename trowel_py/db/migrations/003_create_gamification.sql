...
create index idx_event_log_type on event_log(event_type, triggered_at); -- like "find all daily_logon type event and sort by time"

create table event_cooldowns( -- anti-brush, like 'daily login'
...
create table cold_start_answers( -- used for record q-a when user first used trowel?
    id text primary key,
